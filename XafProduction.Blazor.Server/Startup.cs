...
using XafProduction.Blazor.Server.Services;
...
using XafProduction.WebApi.JWT;
...
public class Startup {
    ...
    public void ConfigureServices(IServiceCollection services) {
        ...
        services.AddXaf(Configuration, builder => {
            builder.UseApplication<XafProductionBlazorApplication>();
            ...
            builder.Modules
                ...
                .AddViewVariants()
                .Add<XafProduction.Module.XafProductionModule>()
                .Add<XafProductionBlazorModule>();
            ...
            builder.Security
                .UseIntegratedMode(options => {
                    ...
                    options.UserType = typeof(XafProduction.Module.BusinessObjects.ApplicationUser);
                    // ApplicationUserLoginInfo is only necessary for applications that use the ApplicationUser user type.
                    // If you use PermissionPolicyUser or a custom user type, comment out the following line:
                    options.UserLoginInfoType = typeof(XafProduction.Module.BusinessObjects.ApplicationUserLoginInfo);
        ...
        services.AddSwaggerGen(c => {
            ...
            c.SwaggerDoc("v1", new OpenApiInfo {
                Title = "XafProduction API",
                Version = "v1",
                Description = @"Use AddXafWebApi(options) in the XafProduction.Blazor.Server\Startup.cs file to make Business Objects available in the Web API."
            });
    ...
    public void Configure(IApplicationBuilder app, IWebHostEnvironment env) {
        if(env.IsDevelopment()) {
            ...
            app.UseSwagger();
            app.UseSwaggerUI(c => {
                c.SwaggerEndpoint("/swagger/v1/swagger.json", "XafProduction WebApi v1");
            });
        }
        else {
